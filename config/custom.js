...
module.exports.custom = {
  ...
  *                                                                         *
  **************************************************************************/
  baseUrl: `http://localhost:${require('./env/development').port}`,
  ...
  *                                                                         *
  **************************************************************************/
  stripePublishableKey: 'pk_test_MV64SwArwZhVNjrud4WzBdL100Qz7lEscn',
  stripeSecret: 'sk_test_WuJxQmLZDnIfMTaHDKIyPgNd005FWl6tUb',
  //--------------------------------------------------------------------------
